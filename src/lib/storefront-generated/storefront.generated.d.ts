...
export type GetShopifyProductDataQuery = { product?: StorefrontTypes.Maybe<(
    ...
    & { featuredImage?: StorefrontTypes.Maybe<Pick<StorefrontTypes.Image, 'url' | 'height' | 'width'>>, options: Array<Pick<StorefrontTypes.ProductOption, 'name' | 'values'>>, images: { nodes: Array<Pick<StorefrontTypes.Image, 'width' | 'height' | 'url'>> }, variantBySelectedOptions?: StorefrontTypes.Maybe<(
